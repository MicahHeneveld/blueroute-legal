...
*This policy was prepared to reflect the app's data practices as of the effective date. Review it before each App Store submission to keep it consistent with the App Store Connect "App Privacy" questionnaire (see [`APP_STORE_PRIVACY.md`](./APP_STORE_PRIVACY.md)).*
